...
$valor="tem";
 $query_buscar = $pdo->query("SELECT * from processos where favorito='sim'");
 ...
 if(@count($dados_buscar)>0){
	...
	//mostra os dados
  	...
  	$dados[] = array(
		...
		'favorito' => $dados_buscar[$i]['favorito'],
	...
	echo $result;
 	 ...
 	 $result = json_encode(array('mensagem'=>'favorito não encontrado'));
 	 echo $result;
