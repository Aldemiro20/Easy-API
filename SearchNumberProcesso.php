...
$postjson = json_decode(file_get_contents("php://input"), true);
 ...
 $query_buscar = $pdo->query("SELECT * from processos where n_processo='$postjson[pesquisa]'  ORDER BY id DESC limit 1 ");
 ...
 if(@count($dados_buscar)>0){
	...
	echo $result;
 	 ...
 	 $result = json_encode(array('mensagem'=>'Processo não encontrado'));
 	 echo $result;
